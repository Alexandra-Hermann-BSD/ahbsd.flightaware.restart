...
namespace ahbsd.lib.flight
{
    ...
    public interface IModule
    {
        ...
        /// </summary>
        event ChangeEventHandler<bool> OnRunningChanged;
        /// <summary>
        /// Happens, when PID changed.
        /// </summary>
        event ChangeEventHandler<uint?> OnPidChanged;
        /// <summary>
        /// Happens, when Notice changed.
        /// </summary>
        event ChangeEventHandler<string> OnNoticeChanged;
    }
}
